...
export default function AuditReport() {
  ...
  const providers = [
    { name: 'AWS', score: 74, critical: 2, high: 2, medium: 2, low: 1 },
    { name: 'GCP', score: 68, critical: 1, high: 2, medium: 2, low: 1 },
    { name: 'Azure', score: 79, critical: 0, high: 1, medium: 2, low: 2 },
  ];
  ...
  const roadmaps = [
    {
      ...
      color: 'red',
      items: [
        'Resolve 3 critical findings - MFA enforcement, S3 bucket exposure, service account permissions',
    ...
    },
    {
      ...
      color: 'orange',
      items: [
        'Address all 7 high severity findings',
    ...
    },
    {
      ...
      color: 'blue',
      items: [
        'Remediate remaining medium and low severity findings',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            ...
            <span className="flex items-center gap-2">
              ...
              Audit Period: Apr 29 - May 29, 2026
            </span>
          </div>
        </div>
              ...
              <div className="grid grid-cols-3 gap-6 mt-5">
                <div className="col-span-2">
                  <p className="text-sm text-slate-700 leading-relaxed mb-4">
                    This audit report identifies 31 security findings across AWS, GCP, and Azure infrastructure for Internee.pk.
                    The overall security posture score is 74%, with 3 critical findings requiring immediate attention.
              ...
              <div className="grid grid-cols-3 gap-6 mt-5">
                {providers.map(p => (
                  <div key={p.name} className="border border-slate-200 rounded-lg p-4">
                    <h3 className="text-sm font-bold text-slate-900 mb-3">{p.name}</h3>
        ...
        <div className="mt-8 text-center text-xs text-slate-400">
          ...
          <p>Document ID: AUDIT-2026-05-001 · Classification: Internal Use Only</p>
        </div>
      </div>
    </div>
  );
